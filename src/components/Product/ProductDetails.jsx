...
const ProductDetails = () => {
    ...
    const submitHandler = (e) => {
        ...
        const reviewUserMag = reviewMsg.current.value
                    ...
                    <Row>
                        <Col lg='12'>
                            <div className="tab_wrap d-flex align-items-center gap-5">
                                <h6 className={`${tab} === 'desc' ? 'active_tab' : ''`} onClick={() => setTab('desc')}>상품설명</h6>
                                <h6 className={`${tab} === 'rev' ? 'active_tab' : ''`} onClick={() => setTab('rev')}>리뷰 ({reviews.length})</h6>
                            </div>
                            {
